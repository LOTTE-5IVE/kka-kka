export default function GoogleLogin() {
  ...
  const requestUri = `https://accounts.google.com/o/oauth2/v2/auth/authorize?response_type=code&client_id=${CID}&redirect_uri=${REDIRECT_URL}&state=${STATE}&scope=${SCOPE}`
  return (
      <a href={requestUri}>
        <button>
          구글 로그인
